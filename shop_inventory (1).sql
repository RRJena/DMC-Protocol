...
CREATE TABLE `budget` (
  ...
  `approved_budget` bigint(20) DEFAULT NULL,
  `total_purchase` bigint(20) DEFAULT NULL
...
CREATE TABLE `item` (
  ...
  `min_stock` bigint(10) NOT NULL DEFAULT '0',
  `max_stock` bigint(10) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
